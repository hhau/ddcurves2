...
#'
#' @param model_fit an "initial_amplitde model" stanfit object
#' @param stan_dat the data associated with the model_fit object, for format of
#' this list, see \code{\link{initial_amplitude_model}}
