data {
  ...
  // pass the empirical cholesky of the correlation matrix in 
...
parameters {
  ...
  vector<lower = 1000, upper = 1050>[n_times] beta_zero;
  ...
  real<lower = 1000, upper = 1050> mean_beta_zero;
